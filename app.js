...
//  When joe.scope() is invoked, `this` refers to the 'joe' object itself.
//  That's because the method 'scope()' is being called on the 'joe' instance.
//  In other words, `this` refers to the object that the method was called on.

// 2. What is "this" when joe.scopeArrow() is invoked?

// Since `scopeArrow` is an arrow function, `this` refers to the global object.
// In this case the arrow function is inheriting the `this` value from the global scope.

// 3. Explain why "this" is different when an arrow function is used.

// Arrow funcitons don't have object bindings and instead inherit their `this` 
// value from their surrounding scope. In this case `global` or `window`.
